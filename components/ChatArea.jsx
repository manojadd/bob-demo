...
export default class Chat extends React.Component{
   ...
   handleToggle(){this.setState({openDrawer: !this.state.openDrawer});};
	...
	handleClose(){
		this.setState({addOpen:false,membersList:[],addedMembers:[]})
	}
	...
	handleSubmit(){
		...
		this.setState({addOpen:false,create:false,membersList:[],addedMembers:[]});
	}
  ...
  let display=  <Dialog title="AddMembers" actions={actions} modal={false} open={this.state.addOpen} onRequestClose={this.handleClose}>
   ...
   if(this.props.channelID.split("#")[1]=="general"){
  	showMembers=(<IconMenu open={this.state.membersOpen}
   ...
   else if(this.props.channelID.split("#")[1]=="GitHub")
   {
  	...
  	addMembers=(   <IconMenu iconButtonElement={<IconButton onTouchTap={this.handleAddMembers}><PersonAdd /></IconButton>} >
  </IconMenu>);
