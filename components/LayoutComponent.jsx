...
export default class LayoutComponent extends Component {
    ...
    constructor(props){
        ...
        this.state={
            ...
            position: 'bottom',
            noOverlay: false,
            anchorEl:ReactDOM.findDOMNode(this.refs.popover)
           }
  ...
  render() {
    ...
    if(this.state.layout.length>0)
    {
      ...
      return (
            <MuiThemeProvider>
            <Paper>
            <ReactGridLayout style={{height:'100%'}} className="layout"
             onLayoutChange={this.saveLayout.bind(this)} layout={this.state.layout}
              cols={10} width={1200} rowHeight={70} verticalCompact={true}>
