const mongoose = require('mongoose')
   , db = require('./../connections/dbconnect.js') //creating a connection to mongodb
   , client = require('./../connections/redisclient.js')
   , async = require('async')
   , ajax = require('superagent')
   , request = require('superagent-relative')
   , pushToRedis = require('./../PushToRedis');

//schema
var bookmarkData = require('./../model/bookmarkSchema.js')
 , ChannelInfo = require('./../model/channelinfo.schema.js')
 , ChatHistorymodel = require('./../model/chathistory.schema.js')
 ...
 , LatList = require('./../model/lat.schema.js')
